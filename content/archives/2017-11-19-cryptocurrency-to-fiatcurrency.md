...
subtitle: '仮想通貨の情報を集めているとよくフィアット（Fiat）という単語を目にします。知るまでは不思議な表現ですが、知ると使いたくなります。'
---
...
今日からブログを AMP 対応しました。AMP は Google が推進する技術で、検索から訪れた時にブログを高速表示できます。Google 検索の時に、ブログ URL の最初に稲妻マークが表示されてたら、AMP が使われています。

{{<img src="/images/2017/11/cryptocurrency-to-fiatcurrency.png" width="1092" height="614">}}