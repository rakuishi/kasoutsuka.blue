...
title: '仮想通貨（ビットコイン）とポイントカードはどう違うのか？'
subtitle: '日常にある仮想通貨もどきのポイントカードから、仮想通貨（ビットコイン）の仕組みを掘り下げていきましょう'
---
...
## ポイントカードは日常にある仮想通貨もどき

それはポイントカードです。日常にあるポイントカードで有名なのは、こんなところでしょうか。
...
さて、これらのポイントと比べて、仮想通貨の仕組みはどのように違うのでしょうか？
...
銀行側もかなり頭を捻ってシステムを作り上げているため、それはとても難しいのですが、恐らく、そのシステムの中からあなたの通帳残高の桁数を上げるか、直前のチャージの金額の桁数を上げるだけでミッション完了です。これが銀行や、ポイントカードの弱点です。
...
このように、**集中管理されている（中央集権型）通貨やポイントは、どうしてもその中央に依存**してしまいます。また、銀行やポイントサービスの会社のセキュリティにも依存しています。

一方で、多くの仮想通貨は一箇所で集中管理されているわけではなく、世界中で分散管理（非中央集権型）されています。**非中央集権型の仮想通貨は、コントロールできる代表者が不在**で、その価値は仮想通貨を持っているユーザーの信用や需要で決まる。

仮想通貨が非中央集権型を取れる理由は、またの記事で紹介していきますね。
